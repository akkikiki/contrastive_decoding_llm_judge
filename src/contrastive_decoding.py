    ...
    def _contrastive_decoding(
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(
            ...
            next_token_logits = _select_contrast(
                base_logits,
                final_logits,
                lamb=self.config.contrastive_lamb,
                temperature=self.config.contrastive_asst_temperature,
                )
    ...
    def generate_contrastive(
        ...
        **kwargs,
        ...
        if generation_mode == GenerationMode.ASSISTED_GENERATION:
            ...
            model_kwargs['return_sequences'] = 10
...
class ContrastiveQwen2ForCausalLM(Qwen2ForCausalLM, ContrastiveGenerationMixin):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
def _select_contrast(
    ...
    final_logits, base_logits = _relative_top_filter(final_logits, base_logits, min_tokens_to_keep=1000, temperature=temperature)
    logits = (final_logits) - (lamb * base_logits)
    return logits
